...
export function StatusBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 h-7 bg-black/90 backdrop-blur border-t border-white/[0.06] flex items-center justify-between px-4 select-none">
      {/* Left — session info */}
      <div className="flex items-center gap-0 h-full">
        {/* Mode badge — tmux-style segment */}
        ...
        <span className="font-mono text-[10px] text-gray-400 px-3">
          root@yudi:
          <span className="text-neon-cyan">~/vitoryudi</span>
        </span>
      </div>

      {/* Right — social links */}
      <div className="flex items-center gap-1 h-full">
        <div className="w-0 h-0 border-t-[14px] border-b-[14px] border-r-[8px] border-t-transparent border-b-transparent border-r-white/[0.06]" />
        <div className="flex items-center gap-0.5 bg-white/[0.03] px-2 h-full">
          <a
            href="https://github.com/vityudi"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1 px-2 h-full text-gray-500 hover:text-white transition-colors group"
          ...
          >
            ...
            <span className="font-mono text-[10px] hidden sm:inline opacity-0 group-hover:opacity-100 transition-opacity">
              vityudi
            </span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1 px-2 h-full text-gray-500 hover:text-neon-cyan transition-colors group"
          ...
          <button
            onClick={copyEmail}
            className="flex items-center gap-1 px-2 h-full text-gray-500 hover:text-neon-green transition-colors group"
